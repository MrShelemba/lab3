...
figure(7)
subplot(3, 1, 1); stepz(b, a);
title('Графік перехідного процесу при r = 0.6');
subplot(3, 1, 2); stepz(b1, a1);
title('Графік перехідного процесу при r = 0.7');
subplot(3, 1, 3); stepz(b2, a2);
title('Графік перехідного процесу при r = 0.9');
...
%=== Завдання #3.4 ===
% Фільтрація сигналу ЕКГ(файл ecg2x60.dat) режекторним фільтром
